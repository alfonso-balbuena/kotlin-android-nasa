...
Second project for Android Kotlin Developer Nanodegree.
...
In the folder starter, open the file apiKey.properties in API_KEY = "" put your api key from [NASA](https://api.nasa.gov/)
